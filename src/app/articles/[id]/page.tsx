...
interface SingleArticlePageProp {
    params: { id: string }
}

const SingleArticlePage = async ({ params }: SingleArticlePageProp) => {
    ...
    return <section className="fix-height container m-auto w-full px-5 pt-8 md:w-3/4">
